...
def build_prompt(raw_text: str, outputs: list[str], terms_text: str, custom_prompt: str = "") -> str:
    ...
    output_labels = {
        ...
        "title": "Haber başlığı öner",
        "spot": "Spot metin oluştur",
        "web_news": "Haber metni oluştur",
        "english_news": "Haber metni İngilizce versiyonunu oluştur",
        "linkedin_post": "LinkedIn paylaşımı oluştur",
        "x_post": "X paylaşımı oluştur",
        "instagram_post": "Instagram paylaşımı oluştur",
        "nsocial_post": "Nsosyal paylaşımı oluştur",
        "bluesky_post": "Bluesky paylaşımı oluştur",
...
{{
  ...
  "nsocial_post": "Nsosyal paylaşımı burada",
  "bluesky_post": "Bluesky paylaşımı burada",
...
def demo_response(outputs: list[str], raw_text: str) -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        ...
        "web_news": "Demo mod: Haber metni için gerçek AI sağlayıcısı bağlayın. Girdi özeti: " + text,
        ...
        "nsocial_post": "Demo mod: Nsosyal paylaşımı gerçek AI sağlayıcısı bağlandığında üretilecektir.",
        "bluesky_post": "Demo mod: Bluesky paylaşımı gerçek AI sağlayıcısı bağlandığında üretilecektir.",
